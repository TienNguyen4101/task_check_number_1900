...
<body>
	...
	<div style="margin-top: 20px; line-height: 1.8; font-size: 17px; font-family: Times New Roman, arial, helvetica">
		...
		<table>
			<tbody>
				<tr>
					<td
						style="text-align: left; font-family: Times New Roman, arial, helvetica; border-bottom: 1px solid #f2f2f2">
						<i>Kính gửi bộ phận admin, kế toán, đối soát và kỹ thuật của <font
								style="color:#199cd9;font-weight:650"> DIGITEL</font>.</i>
						<br>
					</td>
				</tr>
				<tr>
					<td
						style="text-align: left; font-family: Times New Roman, arial, helvetica; border-bottom: 1px solid #f2f2f2">
						<font style="border-bottom: 1px solid #f2f2f2">Dưới đây là danh sách những khách hàng quá hạn
							tạm ngưng đến ngày <font style="font-weight:bold">' . date('Y-m-d H:i:s') . '</font>
							- Sẽ bị thu hồi vào ngày <font style="font-weight:bold">'. date('Y-m-d', strtotime('+2
								days')) .'</font> .</font>
						<br>
						<font style="font-weight:500;border-bottom:1px solid #f2f2f2">Danh sách gồm những khách hàng kèm
							đầu số đã quá hạn tạm ngưng 17 ngày. Xem chi tiết ở File Excel đính kèm. </font>
					</td>
					<td><br></td>
				</tr>
				<tr>
					<td>
						<table width="100%" style="border-collapse: collapse; padding: 8px">
							<tbody>
								<tr>
									<th bgcolor="#00BFFF"
										style="font-weight: bold; padding: 8px; border: 0.5px solid black; text-align: center">
										MÃ KHÁCH HÀNG</th>
									<th bgcolor="#00BFFF"
										style="font-weight: bold; padding: 8px; border: 0.5px solid black; text-align: center">
										ĐẦU SỐ</th>
				...
				<tr>
					<td
						style="text-align: left; border-bottom: 1px solid #f2f2f2; font-family: Times New Roman, arial, helvetica; border-bottom: 1px solid #f2f2f2">
						<font style="border-bottom: 1px solid #f2f2f2">Danh sách này được thực hiện 1 cách tự động, vì
							vậy nếu có khách hàng nào không nằm trong danh sách trên vui lòng báo lại kỹ thuật để xử lý.
						</font>
					</td>
				</tr>
			</tbody>
	...
	<div style="margin-top:20px;margin-right:40px;margin-bottom:10px;font-family:cursive;text-align:right">
		<span><i><u></u>DIGITEL Forever<u></u></i></span>
	</div>
		...
		<tbody>
			<tr>
				<td style="width:160px;border-right:2px solid #f2f2f2">
					<img width="150px"
						src="https://ci5.googleusercontent.com/proxy/mun0lp1GsK5zYsuuPCPVUjRrtV9IQAaAOER82cxucfBEhx86DI_7fJs359wlMoVtN6xYcFwb6Hsjq0QQcNBrlI2rfctr7UFDZ77eDXzG7nLTxwxOKai3n9eCg-8=s0-d-e1-ft#http://183.91.185.198/VoiceReport/crond/sendNoteCustomers/LOGODIGITEL.png"
						class="CToWUd" data-bit="iit">
				</td>
				<td style="text-align:top;margin-left:10px">
					<div style="color:#ffffff;font-size:1px">CÔNG TY CỔ PHẦN HẠ TẦNG VIỄN THÔNG SỐ (DIGITEL)</div>
					<p style="font-weight:bold"><a href="http://digitelgroup.vn/" rel="noreferrer" target="_blank"
							data-saferedirecturl="https://www.google.com/url?q=http://digitelgroup.vn/&amp;source=gmail&amp;ust=1700040086109000&amp;usg=AOvVaw2PG35R-9UMfSYY5fnuTcwN">CÔNG
							TY CỔ PHẦN HẠ TẦNG VIỄN THÔNG SỐ (DIGITEL)</a><br><br></p>
					Địa chỉ giao dịch: A24/D7 Khu đô thị mới Cầu Giấy, Phường Dịch Vọng, Quận Cầu Giấy, Thành phố Hà
					Nội, Việt Nam.<br>
					Tel: (024-028) 8888 1111 | 1900999990 | <a href="http://digitelgroup.vn" rel="noreferrer"
						target="_blank"
						data-saferedirecturl="https://www.google.com/url?q=http://digitelgroup.vn&amp;source=gmail&amp;ust=1700040086109000&amp;usg=AOvVaw040QmXNZL8JPuoJOU_yxub">http://digitelgroup.vn</a><br>
					Email: <a href="mailto:admin@digitel.org.vn" rel="noreferrer"
						target="_blank">admin@digitel.org.vn</a>
