...
function template_export_by_array($data, $path_to_save, $name_file)
{
    if (!empty($data)) {
		...
		$sheet->setCellValue('A' . $lastRow, "                                                          CÔNG TY CỔ PHẦN HẠ TẦNG VIỄN THÔNG SỐ (DIGITEL)\n"
			. "                                                          Địa chỉ giao dịch: Số OF03-19 toà OF Vinhomes West Point, Phạm Hùng, Phường Mễ Trì, Quận Nam Từ Liêm, Thành phố Hà Nội.\n"
